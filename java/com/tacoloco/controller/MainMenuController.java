...
import com.tacoloco.controller.error.MenuListServiceItemNotFoundException;
...
public class MainMenuController {
    ...
    public MenuItem retreiveMenuItem(@PathVariable Long id){
        MenuItem item = this.menuService.findById(id);
        if(item==null){
            
           
            throw new MenuListServiceItemNotFoundException(id);
        }
        return  item;
    }
    //method just for purpose of demonstration not needed for the actual implementation
